...
c = [x.name for x in humans if x.name[0] >= 'C' if x.name[0] <= 'G']
print(c)
...
f = [tuple([x.name,x.age]) for x in humans if x.age >= 27 if x.age <= 32]
print(f)
...
upper_humans = humans
g = [(Human(x.name.upper(),x.age + 5)) for x in upper_humans]
print(g)
